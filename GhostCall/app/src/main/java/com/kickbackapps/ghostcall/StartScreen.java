                    ...
                    if (!isEffectsLoaded) {
                        ...
                        if (!soundEffectsDataList.isEmpty()) {
                            for (int i = 0; i < soundEffectsDataList.size(); i++) {
                                List<com.kickbackapps.ghostcall.SoundEffects.Item> effectItems = soundEffectsDataList.get(i).getItems();
                    ...
                    if (!isBackgroundLoaded) {
                        ...
                        if (!backgroundEffectsDataList.isEmpty()) {
                            for (int i = 0; i < backgroundEffectsDataList.size(); i++) {
                                List<com.kickbackapps.ghostcall.BackgroundEffects.Item> backgroundItems = backgroundEffectsDataList.get(i).getItems();
